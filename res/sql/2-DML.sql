...
--출근일시
INSERT ALL
   INTO ATTEND(ATTNO,EMPNO,A_START,A_END) VALUES (1,1002,to_date('2023-07-04,08:59','YYYY-MM-DD,HH24:MI'),to_date('2023-07-04,18:30','YYY-MM-DD,HH24:MI'))
   INTO ATTEND(ATTNO,EMPNO,A_START,A_END) VALUES (2,1001,to_date('2023-07-04,09:05','YYYY-MM-DD,HH24:MI'),to_date('2023-07-04,18:35','YYY-MM-DD,HH24:MI'))
   INTO ATTEND(ATTNO,EMPNO,A_START,A_END) VALUES (3,1003,to_date('2023-07-04,08:50','YYYY-MM-DD,HH24:MI'),to_date('2023-07-04,18:20','YYY-MM-DD,HH24:MI'))
SELECT 1 FROM DUAL;
COMMIT;