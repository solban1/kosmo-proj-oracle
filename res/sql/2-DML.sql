...
INSERT ALL
   ...
   INTO SCHEDULE (S_NO, DEPTNO, S_BODY, S_START, S_END) VALUES (5, 20, '저녁 회의', to_date('2023-07-11,16:00', 'YYYY-MM-DD,HH24:MI'), to_date('2023-07-11,18:00', 'YYYY-MM-DD,HH24:MI'))
   INTO SCHEDULE (S_NO, DEPTNO, S_BODY, S_START, S_END) VALUES (6, 20, '저녁 회식', to_date('2023-07-06,17:00', 'YYYY-MM-DD,HH24:MI'), to_date('2023-07-06,20:00', 'YYYY-MM-DD,HH24:MI'))
   ...
   INTO SCHEDULE (S_NO, DEPTNO, S_BODY, S_START, S_END) VALUES (9, 20, '저녁 회의', to_date('2023-07-16,16:00', 'YYYY-MM-DD,HH24:MI'), to_date('2023-07-16,18:00', 'YYYY-MM-DD,HH24:MI'))
   INTO SCHEDULE (S_NO, DEPTNO, S_BODY, S_START, S_END) VALUES (10, 20, '아침 청소 기간', to_date('2023-07-14,09:00', 'YYYY-MM-DD,HH24:MI'), to_date('2023-07-17,10:00', 'YYYY-MM-DD,HH24:MI'))
   INTO SCHEDULE (S_NO, DEPTNO, S_BODY, S_START, S_END) VALUES (11, 20, '운동회', to_date('2023-07-12,09:00', 'YYYY-MM-DD,HH24:MI'), to_date('2023-07-12,18:00', 'YYYY-MM-DD,HH24:MI'))
SELECT 1 FROM DUAL;
COMMIT;
--출근일시
INSERT ALL
